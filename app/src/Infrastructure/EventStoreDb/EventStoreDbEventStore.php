...
namespace App\Infrastructure\EventStoreDb;
    ...
    private function getNextPointer(array $responseData): EventStreamPointer
    {
        foreach ($responseData['links'] as $link) {
            if ($link['relation'] === 'previous') {
                ...
                return EventStreamPointer::fromString($matches[1]);
            }
        }

        throw new \RuntimeException('Unable to find next EventStoreDB pointer');
    }
}
